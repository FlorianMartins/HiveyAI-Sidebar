...
export const PROVIDERS = {
  ...
  openrouter: {
    ...
    models: [
      ...
      ["qwen/qwen3.8-max-prime", "Qwen3.8 Max Prime (paid)"],
      ...
      ["mistralai/mistral-medium-3.1", "Mistral Medium 3.1 (paid)"],
      ["z-ai/glm-5.3-prime", "GLM 5.3 Prime (paid)"],
      ["z-ai/glm-5.3-flashx", "GLM 5.3 FlashX (paid)"],
